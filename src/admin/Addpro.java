...
public class Addpro extends JFrame {
	...
	public Addpro() {
		...
		j1.setText(" ADD A NEW PROFESSOR");
		...
		JLabel lblNewLabel_3 = new JLabel("PROFESSOR NAME");
...
JButton button = new JButton("VALIDATE ") ;
	...
	public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				System.out.println( );
				String sql ="insert into professeur values ("+ textField.getText() + ",'" + textField1.getText() + "' , '" + textField2.getText() + "' , " + textField3.getText() + " )";
