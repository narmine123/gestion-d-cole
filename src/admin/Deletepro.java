...
public class Deletepro extends JFrame {
	public Deletepro() {
		...
		this.setTitle("DELETE A PROFESSOR");
		this.getContentPane().setBackground(new Color(139,170,218));
		this.setVisible(true);
		JLabel j1=new JLabel();
		j1.setText("DELETE AN EXISTANT PROFESSOR");
...
JButton button = new JButton("VALIDATE SUPPRESSION") ;
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		try {
			...
			String sql ="delete from professeur where id_prof = " + textField.getText() ;
...
ImageIcon m3 = new ImageIcon ("C:\\Users\\USER\\Desktop\\admin\\prof.png");
iml.setIcon(m3);
imp.add(iml);
