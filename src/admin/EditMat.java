...
public class EditMat extends JFrame {
	...
	public EditMat() {
		...
		j1.setText(" Edit AN EXISTANT SUBJECT");
...
JButton button = new JButton("VALIDATE ") ;
	...
	public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				System.out.println( );
				String sql ="update matiere set nom_matiere = '" + textField2.getText() +  "' where id_grp = '" + textField.getText() + "'" + " and id_prof = " + textField1.getText() ;
