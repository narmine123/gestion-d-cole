...
public class Deletemat extends JFrame {
	...
	public Deletemat() {
		...
		this.setTitle("DELETE SUBJECT");
		this.getContentPane().setBackground(new Color(139,170,218));
		this.setVisible(true);
		JLabel j1=new JLabel();
		j1.setText(" DELETE AN EXISTANT SUBJECT");
...
JButton button = new JButton("VALIDATE SUPPRESSION") ;
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		try {
			...
			System.out.println( );
			String sql ="delete from matiere where id_grp = '" + textField.getText() + "' and id_prof = " + textField1.getText() ;
...
ImageIcon m3 = new ImageIcon ("C:\\Users\\USER\\Desktop\\admin\\sch.png");
iml.setIcon(m3);
imp.add(iml);
