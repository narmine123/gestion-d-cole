...
JButton button = new JButton("VALIDATE ") ;
	...
	public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				System.out.println( );
				String sql ="insert into etudiant values ("+ textField.getText() + ",'" + textField1.getText() + "' , '" + textField2.getText() + "' , '" + textField3.getText() + "', '" + textField4.getText() + "')";
